...
public class UserDTO {
    ...
    @Schema(description = "이용자 알림 설정 DTO")
    ...
    @Schema(description = "이용자 알림 설정을 확인합니다.")
    ...
    @Schema(description = "이용자 동의 요청 DTO")
    ...
    @Schema(description = "이용자 동의 정보를 확인합니다.")
    public record UserTermsAgreementsResponse(
            @Schema(example = "user123", description = "사용자 고유 ID")
            String uid,
